...
fn part1(_input: &mut dyn BufRead) -> io::Result<u32> {
    todo!("Algorithmia Quest 7 Part 1")
}

fn part2(_input: &mut dyn BufRead) -> io::Result<u32> {
    todo!("Algorithmia Quest 7 Part 2")
}

fn part3(_input: &mut dyn BufRead) -> io::Result<u32> {
    todo!("Algorithmia Quest 7 Part 3")
}
...
pub(super) fn run() -> io::Result<()> {
    ...
    }
    {
        ...
        println!(
            "{}",
            part2(&mut BufReader::new(File::open("algorithmia_07-2.txt")?))?
        );
    }
    {
        ...
        println!(
            "{}",
            part3(&mut BufReader::new(File::open("algorithmia_07-3.txt")?))?
        );
    }
    Ok(())
}
