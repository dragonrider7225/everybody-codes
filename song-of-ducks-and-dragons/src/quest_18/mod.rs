...
fn part1(_input: &mut dyn BufRead) -> io::Result<u32> {
    todo!("Song of Ducks and Dragons Quest 18 Part 1")
}

fn part2(_input: &mut dyn BufRead) -> io::Result<u32> {
    todo!("Song of Ducks and Dragons Quest 18 Part 2")
}

fn part3(_input: &mut dyn BufRead) -> io::Result<u32> {
    todo!("Song of Ducks and Dragons Quest 18 Part 3")
}
    ...
    }
    {
        ...
        println!(
            ...
            part3(&mut BufReader::new(File::open(
                "song-of-ducks-and-dragons_18-3.txt"
            )?))?
        );
    }
    Ok(())
