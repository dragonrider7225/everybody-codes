...
fn part1(_input: &mut dyn BufRead) -> io::Result<u32> {
    todo!("Song of Ducks and Dragons Quest 13 Part 1")
}

fn part2(_input: &mut dyn BufRead) -> io::Result<u32> {
    todo!("Song of Ducks and Dragons Quest 13 Part 2")
}

fn part3(_input: &mut dyn BufRead) -> io::Result<u32> {
    todo!("Song of Ducks and Dragons Quest 13 Part 3")
}
    ...
    }
    {
        ...
        println!(
            ...
            part2(&mut BufReader::new(File::open(
                "song-of-ducks-and-dragons_13-2.txt"
            )?))?
        );
    }
    {
