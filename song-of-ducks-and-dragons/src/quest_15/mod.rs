...
fn part1(_input: &mut dyn BufRead) -> io::Result<u32> {
    todo!("Song of Ducks and Dragons Quest 15 Part 1")
}

fn part2(_input: &mut dyn BufRead) -> io::Result<u32> {
    todo!("Song of Ducks and Dragons Quest 15 Part 2")
}

fn part3(_input: &mut dyn BufRead) -> io::Result<u32> {
    todo!("Song of Ducks and Dragons Quest 15 Part 3")
}
...
pub(super) fn run() -> io::Result<()> {
    {
        ...
        println!(
            ...
            part1(&mut BufReader::new(File::open(
                "song-of-ducks-and-dragons_15-1.txt"
            )?))?
        );
    }
    {
        ...
        println!(
            ...
            part2(&mut BufReader::new(File::open(
                "song-of-ducks-and-dragons_15-2.txt"
            )?))?
        );
    }
    {
        ...
        println!(
            ...
            part3(&mut BufReader::new(File::open(
                "song-of-ducks-and-dragons_15-3.txt"
            )?))?
        );
    }
    Ok(())
